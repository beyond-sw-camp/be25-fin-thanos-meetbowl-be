 ...
 *
 * <p>회의 리마인더/수정/취소, 회의록 검토 요청·지연 같은 내부 흐름이 X-Internal-Token으로 호출한다. type/resourceType은 문자열로 받아 UseCase에서
 * 검증하며(잘못된 값은 400), 딥링크가 없는 알림이면 resourceType/resourceId는 둘 다 비워 보낸다.
 */
