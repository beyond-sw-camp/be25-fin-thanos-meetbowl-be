...
class SampleTaskControllerTest {
    ...
    @Autowired
    private CreateSampleTaskUseCase createSampleTaskUseCase;
    ...
    void createSampleTask() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/sample-tasks")
                ...
                .andExpect(jsonPath("$.data.sampleTaskId").value(TestCreateSampleTaskUseCase.SAMPLE_TASK_ID.toString()))
        ...
        CreateSampleTaskCommand command = ((TestCreateSampleTaskUseCase) createSampleTaskUseCase).lastCommand;
    ...
    private static class TestCreateSampleTaskUseCase extends CreateSampleTaskUseCase {
        ...
        private static final UUID SAMPLE_TASK_ID = UUID.fromString("00000000-0000-0000-0000-000000000001");
        ...
        public SampleTaskResult execute(CreateSampleTaskCommand command) {
            ...
            return new SampleTaskResult(SAMPLE_TASK_ID, command.ownerUserId(), command.title(), CREATED_AT);
        }
    }
}
