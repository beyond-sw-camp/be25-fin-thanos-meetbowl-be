...
/**
 * 모든 REST API가 사용하는 최상위 응답 포맷이다.
 * 성공 시에는 data/message만, 실패 시에는 error만 내려가도록 null 필드는 직렬화에서 제외한다.
 */
...
public record ApiResponse<T>(
    ...
    public static ApiResponse<Void> fail(ErrorCode errorCode, String message, List<ErrorDetail> details) {
