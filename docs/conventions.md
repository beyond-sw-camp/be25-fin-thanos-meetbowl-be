...
BE가 RabbitMQ 도메인 이벤트를 발행할 때는 공통 발행 구성을 재사용한다.

역할:

```text
common/event/EventTypes
  루트 event-contract에 정의된 eventType 상수

infrastructure/messaging/RabbitMessagingProperties
