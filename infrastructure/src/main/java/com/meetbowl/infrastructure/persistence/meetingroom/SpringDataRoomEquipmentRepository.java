...
public interface SpringDataRoomEquipmentRepository
        extends JpaRepository<RoomEquipmentEntity, UUID> {

    List<RoomEquipmentEntity> findByMeetingRoomId(UUID meetingRoomId);
