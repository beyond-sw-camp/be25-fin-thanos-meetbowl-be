...
/**
 * 회의 진행 세션과 최종 STT 원문 저장에 필요한 JPA 구성 요소를 등록한다.
 *
 ...
 */
@EntityScan(
        basePackageClasses = {MeetingSessionEntity.class, MeetingTranscriptSentenceEntity.class})
@EnableJpaRepositories(
        basePackageClasses = {
            SpringDataMeetingSessionRepository.class,
            SpringDataMeetingTranscriptSentenceRepository.class
        })
@Configuration
