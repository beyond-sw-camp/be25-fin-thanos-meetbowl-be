...
public interface MeetingRepositoryPort {
    ...
    /**
     * 같은 회의실에서 주어진 예정 시간대 [{@code scheduledStartAt}, {@code scheduledEndAt})와 겹치는 활성 회의를 조회한다.
     * 활성은 상태가 SCHEDULED 또는 IN_PROGRESS인 회의를 말하며, 취소/종료된 회의는 제외한다. 회의실 중복 예약 방지에 사용한다.
     *
